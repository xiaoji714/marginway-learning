...
从 [Releases](https://github.com/xiaoji714/marginway-learning/releases/latest) 获取正式 ZIP 和 SHA-256（私有仓库需授权）。下载后仍需满足[运行要求](installation.md#准备与构建)，Chrome 必须加载解压后的 extension 目录，不能直接加载 ZIP；步骤见[安装指南](installation.md)。
