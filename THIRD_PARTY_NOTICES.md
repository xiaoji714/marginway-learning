...
README、静态素材页与官网的 `product-youtube.png` 展示 Jeremy Howard 的 [A Hackers’ Guide to Language Models](https://www.youtube.com/watch?v=jkrNMKz9pWU)，视频采用 YouTube [CC BY](https://www.youtube.com/t/creative_commons) 许可。截图叠加本产品字幕、笔记界面与机器翻译，不代表原作者背书；YouTube 标识仍归其权利人。设置截图为测试环境的空白密钥界面。
